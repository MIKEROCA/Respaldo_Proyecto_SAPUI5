    ...
    function (Controller, History, MessageBox, Filter, FilterOperator) {
        ...
        return Controller.extend("logaligroup.employees.controller.OrderDetails", {
            ...
            factoryOrderDetails: function (listId, oContext) {
                ...
                //se agrega una nueva propiedad al modelo del objeto
            ...
            onSaveSiganture: function (oEvent) {
                ...
                if (!signature.isFill()) {
                    ...
                    siganturePng = signature.getSignature().replace("data:image/png;base64,", "");
